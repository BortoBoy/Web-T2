...
public class LivroController {
	...
	public String cadastrar(Medico livro) {
	...
	@PostMapping("/salvar")
	public String salvar(@Valid Medico livro, BindingResult result, RedirectAttributes attr) {
	...
	@PostMapping("/editar")
	public String editar(@Valid Medico livro, BindingResult result, RedirectAttributes attr) {
	...
	public List<Paciente> listaEditoras() {
