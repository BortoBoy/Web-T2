...
public class EditoraController {
	...
	public String cadastrar(Paciente editora) {
	...
	@PostMapping("/salvar")
	public String salvar(@Valid Paciente editora, BindingResult result, RedirectAttributes attr) {
	...
	@PostMapping("/editar")
	public String editar(@Valid Paciente editora, BindingResult result, RedirectAttributes attr) {
